...
const About = () =>{
    ...
    return(
        ...
        <div className='goal'>
            ...
            <p>
My goals encompass leveraging my passion for innovation and problem-solving in the field of Computer Science to contribute as a Software Developer within a dynamic team. My aspiration is to continuously learn and grow in a collaborative environment, utilizing my expertise in programming languages, algorithms, and other computer programming principles to drive impactful advancements in technology.</p>
